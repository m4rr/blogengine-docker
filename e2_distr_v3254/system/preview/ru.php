...
$self_href = 'javascript:return false;';
  ...
  $return['notes'] = array (
    array (
      ...
      <p>В заметке могут быть подзаголовки, как здесь, <a href="'. $self_href .'">ссылки</a href=""> и разные виды форматирования текста — <i>курсив</i>, <b>жирный</b>, <tt>моноширинный</tt>.</p>
      ...
      <div class="e2-text-table">
        ...
        <tr><td>Челябинск</td><td>Екатеринбургское время</td><td>YEKT</td><td>+5 ч.</td></tr>
        <tr><td>Москва</td><td>Московское время</td><td>MSK</td><td>+3 ч.</td></tr>
        <tr><td>Лондон</td><td>Средне время по гринвичу</td><td>GMT</td><td></td></tr>
        <tr><td>Нью-Йорк</td><td>Североамериканское восточное время</td><td>ET</td><td>−5 ч.</td></tr>
        <tr><td>Сан-Франциско</td><td>Тихоокеанское время</td><td>PT</td><td>−8 ч.</td></tr>
        </table>
      </div>
